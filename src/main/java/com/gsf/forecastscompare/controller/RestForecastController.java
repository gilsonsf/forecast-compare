...
//            Files.copy(file.getInputStream(), path, StandardCopyOption.REPLACE_EXISTING);
    ...
    @PostMapping("/api/previsaoGM")
    public ResponseEntity<?> previsaoGMAjax(@RequestBody SearchCriteria search, Errors errors) {
        ...
        this.listGM = forecastService.executaPrevisaoGM(this.listRawData);

        result.setMsg("executado com sucesso");
